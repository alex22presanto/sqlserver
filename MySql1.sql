...
insert into clientes (nombre, apellido, fechaNac, id_localidad) values ('Marcos', 'Paz', '1932-01-01',2);
insert into clientes (nombre, apellido, telefono, mail, fechaNac, id_localidad) values ('Susana', 'Gomez', '3698-7852', NULL, '1954-03-06',3);
insert into clientes (nombre, apellido, telefono, mail, fechaNac, id_localidad) values ('Juan', 'Perez', '4358-4787', 'juanperez@gmail.com', NULL ,3); 
